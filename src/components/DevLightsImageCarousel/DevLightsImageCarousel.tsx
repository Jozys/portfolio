	...
	return (
		<div className={styles.root}>
			<Carousel showArrows
				...
				infiniteLoop className={styles.carousel}

				verticalSwipe='standard'>

				<div className={styles.item}>
					<div className={styles.innerItem}>
						<img style={{ borderRadius: 12, width: "100%" }} src={Image1}></img>
					</div>
				</div>

				<div className={styles.item}>
					<div className={styles.innerItem}>
						<img style={{ borderRadius: 12, width: "100%" }} src={ESPBreadboard}></img>
					</div>
				</div>
				<div className={styles.item}>
					<div className={styles.innerItem}>
						<img style={{ borderRadius: 12, width: "100%" }} src={Image3}></img>
					</div>
				</div>
				<div className={styles.item}>
					<div className={styles.innerItem}>
						<img style={{ borderRadius: 12, width: "100%" }} src={DevLights_Desktop}></img>
					</div>
				</div>
